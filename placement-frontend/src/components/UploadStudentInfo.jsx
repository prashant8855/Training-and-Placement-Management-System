            ...
            <form onSubmit={handleSubmit}>
                <div className="row">                    
                    <div className="col-sm-6 mx-auto">
                        ...
                        <div className="form-group form-row">
                            <label className="col-sm-4 form-control-label">Graduation Percentage</label>
                            <div className="col-sm-8">
